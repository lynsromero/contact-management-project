                            ...
                            <div class="col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <form action="{{ url('register') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div data-mdb-input-init class="form-outline mb-4">
                                            <label class="form-label" for="form2Example22">Hobby</label>
                                        ...
                                        <div data-mdb-input-init class="form-outline mb-4">
                                            ...
                                            <input type="number" name="mo_no" class="form-control" value="{{ old('mo_no') }}" />
                                            @error('mo_no')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="d-flex align-items-center justify-content-center pb-4">
                                            ...
                                            <a href="{{ url('/') }}" data-mdb-button-init data-mdb-ripple-init
                                                class="btn btn-outline-danger">Login now</a>
                                        </div>
